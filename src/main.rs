...
///   ZBX_OPEN_URL_FMT="https://zabbix.innlog.fr/zabbix.php?action=event.list&filter_eventid={eventid}"
...
async fn main() -> Result<()> {
    ...
    // Timeouts (priorité: sticky > timeout_ms > default > 5000ms)
    ...
    // Action "Ouvrir" (format URL avec {eventid})
